"""
URL configuration for armustnews project.
...
from armustnews import views
from django.conf import settings
from django.conf.urls.static import static
#from armustnews.sitemap import BlogSitemap,StaticSitemap
...
from django.conf.urls.static import static
from django.contrib.sitemaps.views import sitemap
from armustnews.sitemaps import custom_sitemap_index, sitemap_news, sitemap_images, sitemap_images_by_month, sitemap_videos, sitemap_videos_by_month, sitemap_article, sitemap_article_by_month, sitemap_archive, sitemap_archive_by_month
#sitmap end

admin.site.site_header="armustnews Admin"
admin.site.site_title="armustnews Admin"
